...
public class LoginAndRegisterController {
    ...
    public @ResponseBody
    JSONResult loginSub(UserInfo user, HttpSession session, HttpServletRequest req) throws IOException {
    ...
    public String load(String userName, String password, HttpServletRequest request, HttpServletResponse response,
        ...
        if ("register".equals(action)) {
            ...
            try {
                ...
                LOG.error("activate email:{}, validateCode:{}", email, validateCode, e);
